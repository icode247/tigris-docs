...
a [Collection](/overview/databases). Tigris follows the convention of defining models and schemas in `models/tigris` directory. Within that directory, you'll need to another folder that matches the name of your database
