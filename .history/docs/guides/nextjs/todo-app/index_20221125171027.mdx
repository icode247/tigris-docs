...
main();
```
Here we used the `registerSchemas()` method, which accepts the path to the databases and collections that need to be created. Then you all the models in the `models/tigris` directory with
