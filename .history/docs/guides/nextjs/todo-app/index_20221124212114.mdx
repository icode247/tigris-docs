...
a [Collection](/overview/databases). Tigris ollows a convention of having models and schemas in `models/tigris` directory. Within the directory, you'll need to another folder that matches the name of your database name. Then create your schema file. 
