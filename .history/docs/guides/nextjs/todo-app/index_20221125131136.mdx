...
main();
```
Here you used the `registerSchemas()` method which accepts the path to the databases and collections that needs to be created. Then we all the models in the 
