...
For example, create a `models/tigris/todoApp/blogData.ts` file in the root directory of your project and add the code:

```ts title=models/tigris/todoApp/blogData.ts
import {
...
export const COLLECTION_NAME = "blogData";
