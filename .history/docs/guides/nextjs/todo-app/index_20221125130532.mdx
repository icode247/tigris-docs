...
Now automate your schema management to configure how the Tigris instance loader will be executed at runtime and register your schema. Create a `sripts/setup.ts` file in the root directory of your project.
