...
First, install the Tigris CLI with the command 
`brew install tigrisdata/tigris/tigris-cli` for macOS. For other operating systems: [See installation instructions here](https://docs.tigrisdata.com/cli/installation)
