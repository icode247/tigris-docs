...
main();
```
Here we used the `registerSchemas()` method, which accepts the path to the databases and collections that need to be created. Then y all the models in the `models/tigris` directory with
