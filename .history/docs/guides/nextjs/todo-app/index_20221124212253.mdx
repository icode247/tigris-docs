...
For example, create a `models/tigris/blog/todoItems.ts` file in the root directory of your project and add the code be

Add the highlighted code to `models/tigris/blog/todoItems.ts` file:
