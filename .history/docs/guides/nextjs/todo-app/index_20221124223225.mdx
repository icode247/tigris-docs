...
To get stated, install the Tigris CLI with the command `brew install tigrisdata/tigris/tigris-cli` for macOS. For other Other operating systems: [See installation instructions here
