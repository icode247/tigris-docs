...
Now automate your schema management to configure how the Tigris instance loader will be executed at runtime and register your schema. Create a scripts/setup.ts
