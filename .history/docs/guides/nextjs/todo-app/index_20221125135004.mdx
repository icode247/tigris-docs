...
endpoints will be used by the client component of your application to perform CRUD operations in Tigris. Now create a new folder in the `pages/api/` folder to def
