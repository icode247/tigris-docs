...
Replace <YOUR_PROJECT_NAME> and <YOUR_PROJECT_DESCRIPTION> argumemts with your project name and description respectively. The this will create the credentials and print it on the terminal screen:
