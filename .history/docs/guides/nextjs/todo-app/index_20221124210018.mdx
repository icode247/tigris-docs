...
This guide discusses the concepts behind using Tigris in your existing Nextjs project, and guid you through the process for configuring your application to integrate with MongoDB using Prisma.
