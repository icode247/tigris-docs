...
Add the highlighted code to `models/tigris/todoStarterApp/todoItems.ts`:
...
### Tigirs Automatic schema management
...
Let's see how this works by taking a closer look at  code to
