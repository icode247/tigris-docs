...
This will prompt for the project name. Enter `my-tigris-app` and hit the Enter key. Now you are ready to run your application
...
The above command will create the credentials and print it on the terminal screen:
