...
Tigris applications follows a convention of having models and schemas in `models/tigris` directory. Within these directory, we have a  within
 `todoStarterApp` directory which is also the database name and the file
