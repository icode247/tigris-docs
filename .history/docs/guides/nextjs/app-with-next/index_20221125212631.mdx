...
defined a data model named `TodoItem` to use in our application and created `TodoItemSchema` as a
`We TigrisSchema` for the data model. In the next section we show how these data models are used to
